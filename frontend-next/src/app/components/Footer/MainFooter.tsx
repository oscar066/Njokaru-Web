    ...
    <footer className="bg-[#1c6204] text-white font-serif leading-loose">
      <div className="flex flex-wrap justify-between max-w-6xl mx-auto py-10 px-5 space-y-8 md:space-y-0">
        <div className="w-full md:w-1/4 mb-4">
          ...
          <Link href="/services" className="text-green-500 hover:text-green-300 transition-colors duration-300">
        ...
        <div className="w-full md:w-1/4 mb-4">
          ...
          <ul className="space-y-2">
            {footerLinks.map((link, index) => (
              <li key={index}>
                <Link href={link.href} className="text-gray-300 transition-colors duration-300 hover:text-green-500">
                  {link.label}
                </Link>
              </li>
            ))}
