...
export default function ProductPage() {
  ...
  const products: Product[] = [
    { id: 1, name: "Bermuda Grass", price: 7.99, category: "Grass", image: "/public/Assets/Bermuda-Grass-Lawn-Care.jpg", description: "Drought-resistant and durable grass perfect for high-traffic areas.", rating: 4.5, availability: 100, images: ["/public/Assets/Bermuda-Grass-Lawn-Care.jpg"], dimensions: "500 sq ft coverage", material: "Grass seeds" },
    ...
    { id: 7, name: "Buffalo Grass", price: 11.99, category: "Grass", image: "/public/Assets/Buffalo Grass.jpg", description: "Low-maintenance native grass, drought-resistant and eco-friendly.", rating: 4.6, availability: 60, images: ["/public/Assets/Buffalo Grass.jpg"], dimensions: "300 sq ft coverage", material: "Grass seeds" },
    ...
    { id: 14, name: "Aloe Vera", price: 14.99, category: "Indoor Plants", image: "/public/Assets/aloe-vera.jpg", description: "Succulent plant with medicinal properties.", rating: 4.7, availability: 80, images: ["/public/Assets/aloe-vera.jpg"], dimensions: "10-12 inches tall", material: "Live plant" },
    { id: 15, name: "Bamboo Palm", price: 27.99, category: "Indoor Plants", image: "/placeholder.svg", description: "Indoor palm that helps filter the air.", rating: 4.4, availability: 25, images: ["/placeholder.svg"], dimensions: "36-48 inches tall", material: "Live plant" },
    ...
    { id: 20, name: "Azalea", price: 21.99, category: "Outdoor Plants", image: "/public/Assets/azalea-plant.jpg", description: "Popular shrub with vibrant flowers.", rating: 4.5, availability: 35, images: ["/public/Assets/azalea-plant.jpg"], dimensions: "24-36 inches tall", material: "Live plant" },
    ...
    { id: 22, name: "Camellia", price: 23.99, category: "Outdoor Plants", image: "/placeholder.svg", description: "Flowering plant suitable for cooler climates.", rating: 4.3, availability: 25, images: ["/placeholder.svg"], dimensions: "36-48 inches tall", material: "Live plant" },
    ...
    { id: 24, name: "Bougainvillea", price: 18.99, category: "Outdoor Plants", image: "/public/Assets/Bougainvillea.jpg", description: "Vibrant plant ideal for warmer climates.", rating: 4.6, availability: 30, images: ["/public/Assets/Bougainvillea.jpg"], dimensions: "36-48 inches tall", material: "Live plant" },
    ...
    { id: 29, name: "Bamboo Pot", price: 16.99, category: "Vases", image: "/placeholder.svg", description: "Eco-friendly bamboo pot for small plants.", rating: 4.3, availability: 40, images: ["/placeholder.svg"], dimensions: "8 inches diameter x 7 inches height", material: "Bamboo" },
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <section className="relative h-[60vh] overflow-hidden">
        <div className="absolute inset-0 bg-[url('/hero-bg.jpg')] bg-cover bg-center transform scale-110 motion-safe:animate-subtle-zoom" />
