...
export default function AboutUs() {
  ...
  const values = [
    ...
    },
    {
      ...
      title: "Growth",
      description:
        "We nurture growth in plants, our team, and our clients' visions.",
    },
    {
      icon: Sun,
      title: "Innovation",
      description:
        "We constantly seek new and creative solutions in landscaping.",
    },
    {
      icon: Users,
      title: "Community",
      description:
        "We build lasting relationships with our clients and the community.",
    },
  ];
    ...
    <div className="container mx-auto px-4 py-8">
      <header className="relative text-center mb-12 py-16 bg-gradient-to-r from-green-300 via-green-400 to-green-500 text-white">
        ...
        <p className="text-lg max-w-3xl mx-auto">
          Transforming outdoor spaces into sustainable beauty since 2010.
        </p>
      </header>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-lg leading-relaxed text-gray-600">
              What started as a small team of passionate gardeners has grown
              into a full-service landscaping company, serving both residential
              and commercial clients. Our journey has been marked by a constant
      ...
      <section className="mb-16">
        ...
        <Card className="border border-primary-light bg-primary-light/10 shadow-md">
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed text-gray-600">
              At Njokaru, we strive to create harmonious outdoor environments
              that enhance the beauty of nature while promoting sustainability
              and biodiversity. Our mission is to bring the joy of gardening to
              every home and community we serve, while educating our clients
              about the importance of eco-friendly landscaping practices.
            </p>
          </CardContent>
        </Card>
      </section>
