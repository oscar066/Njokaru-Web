...
const storyItems = [
  {
    title: "Our History",
    content:
      "Founded in 2010, NJOKARU has grown from a small local gardening service to a comprehensive landscaping solution provider. Our journey has been marked by continuous learning, innovation, and a deep commitment to our clients and the environment.",
    image: "/placeholder.svg?height=300&width=500",
    milestones: [
      { year: 2010, event: "NJOKARU founded as a local gardening service" },
      {
        year: 2015,
        event: "Expanded services to include full landscape design",
      },
  ...
  },
  {
    title: "Our Mission",
    content:
      "To create and maintain beautiful, sustainable outdoor spaces that enhance the quality of life for our clients and communities. We strive to blend nature's beauty with innovative design, fostering environments that inspire and rejuvenate.",
    image: "/placeholder.svg?height=300&width=500",
    goals: [
...
const values = [
  ...
  },
  {
    ...
    Icon: LightbulbIcon,
    description:
      "We continuously seek new and creative solutions in landscaping.",
  },
];
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white to-green-50">
      <div className="container mx-auto px-4">
        ...
        >
          <h3 className="text-2xl font-semibold mb-8 text-center text-green-700">
            Our Values
          </h3>
            ...
            {values.map((value, index) => (
              ...
              >
                ...
                <Button
                  ...
                  onClick={() =>
                    setExpandedValue(
                      expandedValue === value.name ? null : value.name,
                    )
                  }
                >
                  {expandedValue === value.name ? (
